...
<body>
 ...
 ?>
  ...
  <ul class="collection with-header">
    ...
    <li class="collection-item">Owner:
      <?php echo $data['masterName']?>
    </li>
    <li class="collection-item">Members:
      <?php echo $data['userCount'],"/",$data['userCountLimit']?>
    </li>
    <li class="collection-item">Fans:
      <?php echo $data['fan']?>
    </li>
  </ul>
